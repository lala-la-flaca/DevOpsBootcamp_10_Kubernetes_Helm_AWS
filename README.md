# ☸️ Kubernetes
## 📦 Demo 4: 
This demo project is part of **Kubernetes Module** from Nana **TWN DevOps Bootcamp**. It focuses on deploying a Dockerized application to a **Kubernetes cluster**, with the container image hosted in **Amazon Elastic Container Registry (ECR)**.
...
- Ensure the application from module 7 is still available on the AWS ECR.
